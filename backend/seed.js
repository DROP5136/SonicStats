...
const ALBUMS = [
  { id: 1,  title: 'Raag Midnight', artist: 'Ravi Shankar Jr', genre: 'Classical', year: 2025, rating: 4.7, totalRatings: 1420, plays: 24100, color: '#8b5cf6', tracks: 12 },
  { id: 2,  title: 'Phir Se', artist: 'Arijit Singh', genre: 'Bollywood', year: 2025, rating: 4.5, totalRatings: 980, plays: 19700, color: '#ec4899', tracks: 10 },
  { id: 3,  title: 'Sun Rhha Hai', artist: 'Shreya Ghoshal', genre: 'Fusion', year: 2024, rating: 4.4, totalRatings: 1105, plays: 17200, color: '#f59e0b', tracks: 14 },
  { id: 4,  title: 'O Re Piya', artist: 'Rahat Fateh Ali Khan', genre: 'Classical', year: 2024, rating: 0, totalRatings: 850, plays: 15800, color: '#3b82f6', tracks: 11 },
  { id: 5,  title: 'Lag Ja Gale', artist: 'Lata Mangeshkar', genre: 'Classical', year: 2025, rating: 4.2, totalRatings: 620, plays: 14300, color: '#1db954', tracks: 9 },
  { id: 6,  title: 'Buzz', artist: 'Badshah', genre: 'Hip Hop', year: 2024, rating: 4.1, totalRatings: 1250, plays: 12900, color: '#f43f5e', tracks: 13 },
  { id: 7,  title: 'Kya Baat Ay', artist: 'Hardy Sandhu', genre: 'Pop', year: 2025, rating: 4.0, totalRatings: 490, plays: 11500, color: '#a855f7', tracks: 10 },
  { id: 8,  title: 'Ganges Flow', artist: 'Nusrat Ali Khan', genre: 'Qawwali', year: 2023, rating: 4.0, totalRatings: 380, plays: 10200, color: '#06b6d4', tracks: 8 },
  { id: 9,  title: 'Himalayan Echo', artist: 'Shaan', genre: 'Pop', year: 2024, rating: 3.9, totalRatings: 410, plays: 9600, color: '#8b5cf6', tracks: 11 },
  { id: 10, title: 'Brown Rang', artist: 'Yo Yo Honey Singh', genre: 'Hip Hop', year: 2025, rating: 3.8, totalRatings: 730, plays: 8700, color: '#f43f5e', tracks: 15 },
  { id: 11, title: 'Kashmir Nights', artist: 'Hariharan', genre: 'Classical', year: 2024, rating: 3.7, totalRatings: 290, plays: 7200, color: '#3b82f6', tracks: 9 },
  { id: 12, title: 'Bangalore Beats', artist: 'Haricharan', genre: 'Fusion', year: 2025, rating: 3.6, totalRatings: 810, plays: 6800, color: '#ec4899', tracks: 16 }
];
 ...
 */
const REVIEWS = [
  { albumId: 1, userId: 'u1', username: 'SalmanKhan',  rating: 5, comment: 'An absolute masterpiece. The production quality is unmatched and every track flows seamlessly into the next.', date: '2025-04-20' },
  { albumId: 1, userId: 'u2', username: 'RahulSharma',     rating: 5, comment: 'Hauntingly beautiful. Every listen reveals a new layer of depth.',                                             date: '2025-04-15' },
  { albumId: 2, userId: 'u3', username: 'Shaan',  rating: 5, comment: 'Arijit Singh keeps pushing emotional boundaries. This album is a journey.',                                    date: '2025-04-19' },
];
